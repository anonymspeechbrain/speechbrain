...
It is a community project, which means that discussions are engaged community-wide while decisions are taken by Anonymous with respect to the community views.
